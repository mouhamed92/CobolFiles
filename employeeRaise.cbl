       ...
       "C:/work space/Cobol path/labs/Files/NEWEMPFILE.DAT"
           ORGANIZATION IS LINE SEQUENTIAL.
       ...
       01  WS-WORK-AREAS.
           ...
           05 WS-INCRASE         PIC 9V99 VALUE 1.03.
       ...
       0100-READ-EMPLOYEES.
           ...
           IF FILE-CHECK-KEY NOT ="00"
               DISPLAY "ERROR IN READING FILE, CODE STATUS :",
                 FILE-CHECK-KEY
      ...
      ****************************************************
           ...
           COMPUTE NEW-HOURLY-RATE = HOURLYRATE  * WS-INCRASE.
